...
$client apply -n ${namespace} -f "release/pipelines/secure-execution-installer/secure-execution-installer-rbac.yaml"
...
$client wait -n ${namespace} deployment http-server --for condition=Available --timeout 10m
