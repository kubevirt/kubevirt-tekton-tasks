...
export CREATE_DATA_OBJECT_IMAGE="${CREATE_DATA_OBJECT_IMAGE:-}"
IMAGE_MODULE_NAME_TO_ENV_NAME["create-data-object"]="CREATE_DATA_OBJECT_IMAGE"
TASK_NAME_TO_IMAGE["create-data-object"]="${CREATE_DATA_OBJECT_IMAGE}"
