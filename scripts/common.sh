...
export MODIFY_DATA_OBJECT_IMAGE="${MODIFY_DATA_OBJECT_IMAGE:-}"
IMAGE_MODULE_NAME_TO_ENV_NAME["modify-data-object"]="MODIFY_DATA_OBJECT_IMAGE"
TASK_NAME_TO_IMAGE["modify-data-object"]="${MODIFY_DATA_OBJECT_IMAGE}"
