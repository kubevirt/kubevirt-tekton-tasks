...
type templateProvider struct {
	templateClient templateclientset.TemplateV1Interface
}
...
func NewTemplateProvider(templateClient *templateclientset.TemplateV1Client) TemplateProvider {
...
func (t *templateProvider) Get(namespace string, name string) (*templatev1.Template, error) {
	return t.templateClient.Templates(namespace).Get(context.TODO(), name, metav1.GetOptions{})
}

func (t *templateProvider) Create(template *templatev1.Template) (*templatev1.Template, error) {
	return t.templateClient.Templates(template.Namespace).Create(context.TODO(), template, metav1.CreateOptions{})
}

func (t *templateProvider) Update(template *templatev1.Template) (*templatev1.Template, error) {
	return t.templateClient.Templates(template.Namespace).Update(context.TODO(), template, metav1.UpdateOptions{})
}
