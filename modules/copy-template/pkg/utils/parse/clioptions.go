...
type CLIOptions struct {
	...
	SetOwnerReference       string            `arg:"--set-ownerreference,env:SET_OWNERREFERENCE" placeholder:"false" help:"Set owner reference to the new object created by the task run pod. Allowed values true/false"`
