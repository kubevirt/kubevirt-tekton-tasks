...
// Pinned to kubernetes-1.16.4 (due to kubevirt/client-gov0.37.2)
replace (
...
// Pinned to pipeline v0.17.3 (due to kubernetes-1.16.4)
replace github.com/tektoncd/pipeline => github.com/tektoncd/pipeline v0.17.3
