...
replace (
	...
	kubevirt.io/containerized-data-importer => kubevirt.io/containerized-data-importer v1.64.0
	kubevirt.io/containerized-data-importer-api => kubevirt.io/containerized-data-importer-api v1.64.0
)

// Openshift
replace (
	github.com/openshift/api => github.com/openshift/api v0.0.0-20251015095338-264e80a2b6e7
...
require (
	...
	kubevirt.io/virt-template-api v0.2.3 // indirect
	kubevirt.io/virt-template-client-go v0.2.2 // indirect
