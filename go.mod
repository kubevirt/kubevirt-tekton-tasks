...
replace (
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi 99599406b04f
...
// Openshift
replace (
	github.com/openshift/api => github.com/openshift/api 831aaaf072a9
	github.com/openshift/client-go => github.com/openshift/client-go 452dfb8fa071
)
...
require (
	...
	knative.dev/pkg f3ab5605e542
	kubevirt.io/api v1.4.0
	kubevirt.io/client-go v1.4.0
	kubevirt.io/containerdisks d7a23bc0fc74
