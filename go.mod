...
// Openshift
replace (
	github.com/openshift/api => github.com/openshift/api b88d06709901
	github.com/openshift/client-go => github.com/openshift/client-go 35abaf51555b
)
...
require (
	...
	knative.dev/pkg 40afb7c5436e
	kubevirt.io/api v1.4.0
	kubevirt.io/client-go v1.4.0
	kubevirt.io/containerdisks 0a8f96854cc6
